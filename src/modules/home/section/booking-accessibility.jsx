...
const BookingAccessibility = () => {
  return (
    <div className="flex my-18 justify-center">
      <div className="w-[960px] flex gap-y-8 flex-col ">
        <h4 className="text-4xl font-Playfair text-stone950 max-w-[400px]">Our goal is Ensure Hotel Booking Accessibility</h4>
        <div className="flex gap-x-8 justify-between">
          <div className="flex gap-6">
            <FaHouseTsunami size={50} className="text-stone900" />
            <div className="flex flex-col gap-y-2">
              <h5 className="font-Playfair">Pick up & Drop</h5>
              <p className="max-w-[300px] text-justify text-xs text-stone950/60">
          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col gap-y-2">
              <h5 className="font-Playfair">Pick up & Drop</h5>
              <p className="max-w-[300px] text-xs text-justify text-stone950/60">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
